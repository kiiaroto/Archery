...
public class Session {
	...
	public int getNbrDeFléche() {
		return nbrDeFléche;
	}

	public void setNbrDeFléche(int nbrDeFléche) {
		this.nbrDeFléche = nbrDeFléche;
	}
	...
	public Session(String nom, int nbrDeVolée, int nbrDeFléche) {
		super();
		this.nom = nom;
		this.nbrDeVolée = nbrDeVolée;
		this.nbrDeFléche =  nbrDeFléche;
