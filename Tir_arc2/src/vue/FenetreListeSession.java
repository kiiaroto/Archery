	...
	public class NouvelleSession implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			Object[] message = {
			    ...
			    "Nombre de fléches:", fleche
			};
			
			// Ser de paramétre a la boucle, si Vrai, fin de boucle, si faux, continue la boucle
			...
			while (!optionsOK) {
				...
				if (option == JOptionPane.OK_OPTION) {
				    ...
				    try {
				        ...
				        int nbrFléche = Integer.parseInt(fleche.getText());
				        
				        FenetreAjoutScore fenetre = new FenetreAjoutScore();
						//nombre de volée, nombre de fléche
				        fenetre.affiche(nbrVolée, nbrFléche, nomSession);
				        optionsOK = true;
					...
					// TODO Auto-generated catch block
					   ...
					   JOptionPane.showMessageDialog(volée, "Merci de choisir un nom de Session valide et qui n'existe pas déjé", "Try again", JOptionPane.ERROR_MESSAGE);
				}
				} else {
	...
	public class SupprimerSession implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (!listeSession.isSelectionEmpty()) {
				...
				int option = JOptionPane.showConfirmDialog(null, "Voulez vous vraiment supprimer: " + listeSession.getSelectedValue(), "étes vous sur?", JOptionPane.YES_NO_OPTION);
