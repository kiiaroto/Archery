...
public class FenetreScore {
	...
	public void affiche(Session session) {
		...
		this.nombreDeFléche = session.getNbrDeFléche();
		this.nombreDeVolée = session.getNbrDeVolée();
		this.nomSession = session.getNom();
		
		// On récupére une liste de toutes les fleche (resultat et total inclus)
		...
		p1.setLayout(new BorderLayout(10,10));
			...
			grille.setLayout(new GridLayout(nombreDeVolée + 1, nombreDeFléche + 3, 10, 0));
				...
				for (int i = 1; i <= nombreDeVolée; i++) {
					...
					// Ajoute é la map le Label avec comme text le résultat de la volée (resultatLigne1, resultatLigne2, resultatLigne3 ...)
					...
					// Ajoute é la map le Label avec comme text le total de la volée (totalLigne1, totalLigne2, totalLigne3 ...)
	...
	public class Modifier implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			modificationScore.affiche(nombreDeVolée, nombreDeFléche, nomSession, arrowList);
